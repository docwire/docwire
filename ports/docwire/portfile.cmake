...
function(run_tests build_type)
	...
	set(valgrind_suppressions_file ${SOURCE_PATH}/tools/valgrind_suppressions.txt)
	set(valgrind_command "")
	if(MEMCHECK_ENABLED)
		set(valgrind_command valgrind --leak-check=full --gen-suppressions=yes --suppressions=${valgrind_suppressions_file})
	elseif(CALLGRIND_ENABLED)
		set(valgrind_command valgrind --tool=callgrind)
	elseif(HELGRIND_ENABLED)
		set(valgrind_command valgrind --tool=helgrind --gen-suppressions=yes --suppressions=${valgrind_suppressions_file})
	endif()
	if (valgrind_command)
	...
	if (valgrind_command)
		...
		file(READ ${valgrind_suppressions_file} valgrind_suppressions_contents)
		message("Contents of valgrind_suppressions.txt:\n${valgrind_suppressions_contents}")
	endif()
