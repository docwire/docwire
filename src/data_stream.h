...
class DOCWIRE_EXPORT FileStream : public DataStream, public with_pimpl<FileStream>
{
	public:
...
class DOCWIRE_EXPORT BufferStream : public DataStream, public with_pimpl<BufferStream>
{
	public:
