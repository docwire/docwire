...
inline bool try_to_int(std::string_view sv, int& out) noexcept
{
...
inline std::optional<std::chrono::sys_seconds> create_sys_seconds(int year, int month, int day, int hour, int minute, int second) noexcept
{
...
inline std::optional<std::chrono::sys_seconds> parse_iso8601(std::string_view s) noexcept
{
    int y, m, d, h, min, sec;
...
inline std::optional<std::chrono::sys_seconds> parse_openoffice_legacy(std::string_view s) noexcept
{
    int y, m, d, h, min, sec;
...
inline std::optional<std::chrono::sys_seconds> parse_asn1(std::string_view s) noexcept
{
    int y, m, d, h, min, sec;
 ...
 */
inline std::optional<std::chrono::sys_seconds> convert_impl(with::date_format::iso8601 s, dest_type_tag<std::chrono::sys_seconds>) noexcept
{
    DOCWIRE_LOG_SCOPE(s);
    return detail::parse_iso8601(s.v);
}
/**
 * @brief Converts a legacy OpenOffice date string to sys_seconds.
 */
inline std::optional<std::chrono::sys_seconds> convert_impl(with::date_format::openoffice_legacy s, dest_type_tag<std::chrono::sys_seconds>) noexcept
{
    DOCWIRE_LOG_SCOPE(s);
    return detail::parse_openoffice_legacy(s.v);
}
/**
 * @brief Converts an ASN.1 date string to sys_seconds.
 */
inline std::optional<std::chrono::sys_seconds> convert_impl(with::date_format::asn1 s, dest_type_tag<std::chrono::sys_seconds>) noexcept
{
    DOCWIRE_LOG_SCOPE(s);
    return detail::parse_asn1(s.v);
}
 ...
 */
inline std::optional<std::string> convert_impl(std::chrono::sys_seconds tp, dest_type_tag<std::string>) noexcept
{
