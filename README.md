...
```cpp
std::filesystem::path("data_processing_definition.doc") | ... | ai::local::embed_passage{} | passage_msgs;
...
docwire::data_source{std::string{"What is data processing?"}, ...} | ai::local::embed_query{} | similar_query_msgs;
...
