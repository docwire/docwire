...
int main(int argc, char* argv[])
{
  ...
  try
  {
    std::filesystem::path("data_processing_definition.doc") | content_type::detector{} | office_formats_parser{} | PlainTextExporter() | ai::local::task("Find sentence about \"data conversion\" in the following text:\n\n") | out_stream;
