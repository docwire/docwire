...
int main(int argc, char* argv[])
{
  ...
  try
  {
    ...
    std::filesystem::path("data_processing_definition.doc") | content_type::detector{} | office_formats_parser{} | PlainTextExporter() | ai::local::embed(ai::local::embed::e5_passage_prefix) | passage_msgs;
    ...
    docwire::data_source{std::string{"What is data processing?"}, mime_type{"text/plain"}, confidence::highest} | ai::local::embed(ai::local::embed::e5_query_prefix) | similar_query_msgs;
    ...
    docwire::data_source{std::string{"How can data analysis improve business efficiency?"}, mime_type{"text/plain"}, confidence::highest} | ai::local::embed(ai::local::embed::e5_query_prefix) | partial_query_msgs;
    ...
    docwire::data_source{std::string{"What is the best C++ IDE?"}, mime_type{"text/plain"}, confidence::highest} | ai::local::embed(ai::local::embed::e5_query_prefix) | dissimilar_query_msgs;
