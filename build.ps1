...
if ($BuildType -eq "Debug")
{
	$LIB_PATHS.Add("C:\Windows\System32\MSVCP140D.dll");
	$LIB_PATHS.Add("C:\Windows\System32\VCRUNTIME140D.dll");
	$LIB_PATHS.Add("C:\Windows\System32\ucrtbased.dll");
	$LIB_PATHS.Add("$vcpkg_bin_dir/pthreadVC3d.dll");
}
