...
function(docwire_modules_using_dependency port_name out_var)
	if(NOT DEFINED docwire_modules_using_dependency_cached_result_${port_name})
		...
		set(docwire_core_deps vcpkg-cmake wv2 boost-filesystem boost-dll boost-json magic-enum minizip zlib gtest curlpp)
		...
		set(docwire_local_ai_deps boost-filesystem boost-system boost-json ctranslate2 opennmt-tokenizer flan-t5-large-ct2-int8)
		set(docwire_fuzzy_match_deps rapidfuzz)
		set(docwire_base64_deps aklomp-base64)
		set(docwire_cli_deps boost-program-options)
		set(modules "")
		foreach(module docwire_core docwire_html docwire_pdf docwire_ocr docwire_xml docwire_mail docwire_plain_text docwire_local_ai docwire_fuzzy_match docwire_base64 docwire_cli)
