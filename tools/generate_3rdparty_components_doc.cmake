...
function(vcpkg_depend_info out_var)
	if(NOT DEFINED vcpkg_depend_info_cached_result)
		message("Executing vcpkg depend_info")
		execute_process(COMMAND ${CMAKE_SOURCE_DIR}/vcpkg/vcpkg depend-info --triplet=${VCPKG_TARGET_TRIPLET} --overlay-ports=${CMAKE_SOURCE_DIR}/ports --format=list --sort=reverse docwire OUTPUT_VARIABLE depend_info ERROR_VARIABLE stderr_content COMMAND_ECHO STDOUT)
		...
		set(vcpkg_depend_info_cached_result ${dep_info_list} CACHE INTERNAL "")
	endif()
	set(${out_var} ${vcpkg_depend_info_cached_result} PARENT_SCOPE)
endfunction()

function(port_dependencies_internal)
	vcpkg_depend_info(dep_info_list)
...
function(vcpkg_package_info out_var)
	if(NOT DEFINED vcpkg_package_info_cached_result)
		...
		message("Executing ${CMAKE_SOURCE_DIR}/vcpkg/vcpkg x-package-info --triplet=${VCPKG_TARGET_TRIPLET} --overlay-ports=${CMAKE_SOURCE_DIR}/ports --x-json ${all_ports}")
