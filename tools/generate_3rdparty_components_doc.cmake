...
function(docwire_modules_using_dependency port_name out_var)
	if(NOT DEFINED docwire_modules_using_dependency_cached_result_${port_name})
		...
		set(docwire_core_deps vcpkg-cmake wv2 boost-filesystem boost-dll boost-json magic-enum unzip zlib gtest curlpp libarchive)
		set(docwire_html_deps lexbor libcharsetdetect)
		set(docwire_pdf_deps pdfium zlib)
		...
		set(docwire_plain_text libcharsetdetect)
