...
function(traverse_dependency_tree_from_vcpkg_json_dependencies_array dependencies_arr port_name)
	...
	foreach(n RANGE ${max_dep_index})
		...
		json_array_to_list(${dep} features default dep_features)
		...
		traverse_dependency_tree_from_port(${dep_name} "${dep_features}")
	endforeach()
endfunction()

function(json_array_to_list json array_name default_val out_var)
...
function(traverse_dependency_tree_from_port port_name features)
	if("${features}" STREQUAL "default")
		port_default_features(${port_name} features)
	endif()
	...
	if(NOT DEFINED traverse_dependency_tree_from_port_${port_name}_${features_str})
		...
		endforeach()
		set(traverse_dependency_tree_from_port_${port_name}_${features_str} CACHE INTERNAL "")
	endif()
endfunction()

function(traverse_whole_dependency_tree)
	traverse_dependency_tree_from_port(docwire default)
endfunction()
